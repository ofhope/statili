...
describe("linearRegressionInsights", () => {
  ...
  describe("insight orchestration", () => {
    it("should generate all expected insights for successful regression", () => {
      const mockSuccess = createMockRegressionSuccess({ slope: 2.5, intercept: 10, r2: 0.85 });
  ...
  describe("error handling", () => {
    ...
    it("should handle DegenerateInput error with specific vertical-line message", () => {
      const mockError = createMockRegressionError("DegenerateInput");
      const result = linearRegressionInsights(defaultOptions, mockError);
    ...
    it("should handle MathError with appropriate guidance", () => {
    ...
    it("should handle NumericalStability error", () => {
      const mockError = createMockRegressionError("NumericalStability");
      const result = linearRegressionInsights(defaultOptions, mockError);
  ...
  describe("options handling", () => {
    ...
    it("should work with partial options", () => {
      const partialOptions = { rSquaredThresholdWeak: 0.4 };
      const mockSuccess = createMockRegressionSuccess();
